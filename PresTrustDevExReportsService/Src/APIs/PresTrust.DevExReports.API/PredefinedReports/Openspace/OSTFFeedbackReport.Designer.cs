...
namespace PresTrust.DevExReports.API.PredefinedReports.Openspace {
    ...
    public partial class OSTFFeedbackReport : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "PresTrust.DevExReports.API.PredefinedReports.Openspace.OSTFFeedbackReport.repx");
