...
namespace PresTrust.DevExReports.API.PredefinedReports.Farm {
    ...
    public partial class FarmPermanentlyPreservedFarmsWithServableExceptionsReport : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "PresTrust.DevExReports.API.PredefinedReports.Farm.FarmPermanentlyPreservedFarmsWi" +
                    "thServableExceptionsReport.repx");
