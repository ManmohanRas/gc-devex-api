...
namespace PresTrust.DevExReports.API.PredefinedReports.Farm {
    ...
    public partial class FarmEsmtTargetedFarmEligibilityReport : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "PresTrust.DevExReports.API.PredefinedReports.Farm.FarmEsmtTargetedFarmEligibility" +
                    "Report.repx");
