...
namespace PresTrust.DevExReports.API.PredefinedReports.Farm {
    ...
    public partial class FarmEsmtPermanentlyPresFarmsTownSummaries : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "PresTrust.DevExReports.API.PredefinedReports.Farm.FarmEsmtPermanentlyPresFarmsTow" +
                    "nSummaries.repx");
