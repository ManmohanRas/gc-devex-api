...
{
    public partial class DevExReportsDomainConstants
    {
        /// <summary>
        /// Class to hold constants for Application Settings (appSetting.json)
        /// </summary>
        public static class AppSettingKeys
        {
            ...
            /// </summary>
            public const string PRESTRUST_SQL_DB_CONNECTION_STRING_SECTION = "GreenCountyDbConnectionStrings";
            /// <summary>
